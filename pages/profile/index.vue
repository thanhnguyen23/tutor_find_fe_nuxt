	...
	<div class="profile-container">
			...
			<div class="nav-tabs">
				<div class="nav-tabs-wrapper">
					<button v-for="tab in tabs" :key="tab.id" :class="['tab', { active: activeTab === tab.id }]"
						...
						<span class="icon">
							<svg v-if="tab.id === 'profile'" class="icon-md" xmlns="http://www.w3.org/2000/svg"
							...
							<svg v-else-if="tab.id === 'overview'" class="icon-md" xmlns="http://www.w3.org/2000/svg"
								width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
								stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
							...
							<svg v-else-if="tab.id === 'schedule'" class="icon-md" xmlns="http://www.w3.org/2000/svg"
								width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
								stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
								<path d="M8 2v4"></path>
								<path d="M16 2v4"></path>
							...
							<svg v-else-if="tab.id === 'wallet'" class="icon-md" xmlns="http://www.w3.org/2000/svg"
								width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
								stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
							...
							<svg v-else class="icon-md" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
		...
		<div class="container">
			<div class="page-content">
				...
				<ProfileInfoNew v-if="activeTab === 'profile'" @update-data="updateProfileData"
					:user-data-detail="userDataDetail" />
				<OverviewNew v-if="activeTab === 'overview'" @update-data="updateProfileData"
					:user-data-detail="userDataDetail" />
				<ScheduleNew v-if="activeTab === 'schedule'" @update-data="updateProfileData"
					:user-data-detail="userDataDetail" />
				<WalletBalance v-if="activeTab === 'wallet'" @update-data="updateProfileData"
					:user-data-detail="userDataDetail" />
			</div>
		</div>
	</div>
